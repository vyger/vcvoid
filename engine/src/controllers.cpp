...
//               L1.1–L1.4 (brightness) and 4 R registers R1.1–R1.4 (colour) —
//               the only controller in the chain with R registers (issue #80).
...
static const ControllerModel kModels[] = {
    // name    pots buttons leds switches enc rgb faders permissive
    {"p2b8",   2,   8,      8,   0,       0,  0,  0,     false},
    {"p4b2",   4,   2,      2,   0,       0,  0,  0,     false},
    {"p10",   10,   0,      0,   0,       0,  0,  0,     false},
    {"s10",    0,   0,      0,  10,       0,  0,  0,     false},
    {"p8s8",   8,   0,      8,   8,       0,  0,  0,     false},
    {"b32",    0,  32,     32,   0,       0,  0,  0,     false},
    {"e4",     0,   4,      4,   0,       4,  0,  0,     false},
    {"m4",     0,   4,      4,   0,       0,  4,  4,     false},
    {"db8e",   0,   9,      9,   0,       1,  0,  0,     false},
};
