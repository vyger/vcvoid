...
- **Never hand-edit** `engine/gen/` — it is code-generated by `make gen`. Its
  inputs are the vendored Forge `droidfirmware.json` and, for vcvoid-only
  circuits, `engine/experimental.json` (hand-authored; see
  [ADR 0001](docs/adr/0001-experimental-circuits.md)). Edit those and rerun
  `make gen`.
